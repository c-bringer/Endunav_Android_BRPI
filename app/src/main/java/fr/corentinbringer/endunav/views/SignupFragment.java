...
public class SignupFragment extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        signupViewModel.setRequiredParameters(getContext(), navController);
        ...
        b.buttonSignup.setOnClickListener(v -> {
            ...
            if(TextUtils.isEmpty(Objects.requireNonNull(signupUser).getStrCompleteName())) {
                Toast.makeText(getContext(), R.string.label_error_name, Toast.LENGTH_LONG).show();
            } else if(!signupUser.isCompleteNameLengthGreaterThan2()) {
                Toast.makeText(getContext(), R.string.label_error_name_length, Toast.LENGTH_LONG).show();
